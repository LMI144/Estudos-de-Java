public class Obralivro implements Livro{
    ...
    private HumanoLivro leitor;

    public Obralivro(String titulo, String autor, int totpag, boolean aberto, HumanoLivro leitor) {
        this.titulo = titulo;
        this.autor = autor;
        this.totpag = totpag;
        this.pgatual = 0;
    ...
    public HumanoLivro getLeitor() {
        return leitor;
    }

    public void setLeitor(HumanoLivro leitor) {
        this.leitor = leitor;
    }
